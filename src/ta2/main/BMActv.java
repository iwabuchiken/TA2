...
//		ib_Up.setOnTouchListener(new BO_TL(this));
	...
	private boolean _onCreate_Set_BMList() {
		...
		CONS.BMActv.bmList = dbu.get_BMList(this, CONS.BMActv.am.getDb_Id());
...
//					+ "child_Count = " + child_Count
	...
	private void _onCreate_Setup_Textviews() {
		...
		tvFileName.setText(CONS.BMActv.am.getText());
...
//		tvTitle.setText(CONS.BMActv.ai.getTitle());
	...
	_onCreate_GetAI() {
		 ...
		 ***************************************/
		CONS.BMActv.am = DBUtils.find_AI_ById(this, aiDbId);
...
//		super.onListItemClick(l, v, position, id);
		...
		i.putExtra(CONS.Intent.iKey_BMActv_AI_Id, bm.getTa_id());
